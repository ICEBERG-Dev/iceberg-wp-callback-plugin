...
function iceberg_crm_callback_handle_token_authentication_callback() {
    if (isset($_POST['iceberg_crm_callback_token'])) {
      $token = sanitize_text_field($_POST['iceberg_crm_callback_token']);
      $response = iceberg_crm_callback_send_token_to_server_callback($token);
      ...
      iceberg_crm_callback_store_token_in_database_callback($token);
...
function iceberg_crm_callback_store_token_in_database_callback($token) {
    global $wpdb;
...
function iceberg_crm_callback_add_token_form_section_callback() {
